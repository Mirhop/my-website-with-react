  ...
  return (
    ...
    <main className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
      <div className="max-w-4xl">
            <h1 className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="./public/project/project.html" className="px-3 py-1 md:px-8 md:py-3 w-full sm:w-auto bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full font-semibold text-white shadow-lg shadow-cyan-500/20 transform hover:scale-105 hover:shadow-cyan-500/30 transition-all duration-300">
                    Explore My Work
                </a>
